<template>
    <div id="main">
        ...
        <musicList v-show="selected=='首页'" @close="close()" v-if="musicShow" class="animated" :class="musicEffect ?'bounceInRight':'bounceOutRight'"></musicList>
        ...
        <mt-tabbar v-model="selected">
            <mt-tab-item id="首页">
                <img v-if="selected!='首页'" slot="icon" src="../../img/international.png">
                <img v-if="selected=='首页'" slot="icon" src="../../img/i_international.png">
                首页
            </mt-tab-item>
            <mt-tab-item id="说说">
                <img v-if="selected!='说说'" slot="icon" src="../../img/social_server_fault.png">
                <img v-if="selected=='说说'" slot="icon" src="../../img/i_social_server_fault.png">
                说说
            </mt-tab-item>
            <mt-tab-item id="在线人数">
                <img v-if="selected!='在线人数'" slot="icon" src="../../img/sub_account.png">
                <img v-if="selected=='在线人数'" slot="icon" src="../../img/i_sub_account.png">
                在线人数
            </mt-tab-item>
            <mt-tab-item id="我的">
